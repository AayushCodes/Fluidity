  ...
  return (
    <main className='bg-black h-screen'>
      ...
      <div className='h-[calc(100vh-88px)] flex mt-3'>
        ...
        <div className='flex h-full w-2/5 justify-center mx-14'>
          <div className='mt-2 w-full shadow-2xl rounded-lg shadow-purple-800'>
            <Chat />
          </div>
        </div>
        <div className='flex flex-grow h-full w-1/4 justify-center mr-3'>
          <div className='mt-2 mx-3 w-full'>
            <UserStreams />
          </div>
        </div>
